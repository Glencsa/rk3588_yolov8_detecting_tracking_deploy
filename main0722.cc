...
struct ProgramOptions
{
  ...
  std::string rtsp_url4 = "rtspsrc location=rtsp://192.168.2.120/554 latency=0  ! rtph264depay !   h264parse !   avdec_h264  max-threads=2  ! videoconvert n-threads=2 !  video/x-raw, format=(string)BGR ! appsink  sync=false";
...
int main()
{
  ...
  auto thread_func3 = [&]()
  {
    ...
    rtsp_set_video(g_rtsp_session177, RTSP_CODEC_ID_VIDEO_H265, NULL, 0);
    ...
    enc_params177.type = MPP_VIDEO_CodingHEVC; // H264MPP_VIDEO_CodingHEVC  MPP_VIDEO_CodingAVC
    ...
    while (1)
    {
      ...
      if (image1 != nullptr)
      {
        ...
        rknn_pool3->AddInferenceTask(std::move(image1), image_process3);
        image_count3++;
      }
