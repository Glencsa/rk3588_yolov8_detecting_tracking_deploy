...
// //                 //cv::Mat *imagess2 = new cv::Mat(elements->heights2, elements->widths2, CV_8UC1, map.data);
            ...
            imageAvailableCond.notify_one();
              SDL_UpdateTexture(texture1, NULL, image_res2->data, image_res2->step);
            ...
            // delete elements->image2; // 使用完毕后释放内存
...
int main(int argc, char *argv[]) {
   ...
   gboolean ret; 
    ...
    SDL_Texture* texture = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_BGR24, SDL_TEXTUREACCESS_STATIC, 1920, 1080);
     SDL_Window* window1 = SDL_CreateWindow("Video1", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1280, 720, 0);
    SDL_Renderer* renderer1 = SDL_CreateRenderer(window1, -1, SDL_RENDERER_SOFTWARE);
    SDL_Texture* texture1 = SDL_CreateTexture(renderer1, SDL_PIXELFORMAT_BGR24, SDL_TEXTUREACCESS_STATIC, 1280, 720);
    /* Initialization of gstreamer */
