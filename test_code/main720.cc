...
// rtsp_demo_handle g_rtsplive163 = NULL;1
...
{
  std::string model_path = "/home/linaro/rknn_model_zoo-main/examples/yolov8/model/yolov8.rknn";//yolov8.rknn   next-n.rknn
  ...
  std::string rtsp_url4 = "rtspsrc location=rtsp://192.168.2.119/554 latency=200 drop-on-latency=true ! rtph264depay !   h264parse !   avdec_h264   ! videoconvert  n-threads=2  ! appsink   ";
   std::string rtsp_url5 = "filesrc location=/home/linaro/720p60hz.mp4 ! qtdemux !   h264parse !   mppvideodec ! videoconvert  n-threads=3  ! appsink   ";
  int width = 1280;
  int height = 720;
  double fps = 25.0;
  int width2 = 1920;
...
// 声明一个用于存储图像数据的缓冲区abmax-threads=31111
